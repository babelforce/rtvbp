...
spec types. The 2026-08-03 soundness review is scheduled as R-17 (missing authority/variants, now in
progress) and R-18 (semantic constraints); R-5 and R-8 remain independently ready behind them.
